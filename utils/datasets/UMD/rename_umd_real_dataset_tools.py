...
########################
########################
data_path = '/data/Akeaveny/Datasets/domain_adaptation/UMD/Downloaded/part-affordance-tools/tools/'
new_data_path = '/data/Akeaveny/Datasets/domain_adaptation/UMD/Sorted/Real_2/'
