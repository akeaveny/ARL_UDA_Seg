...
class DeepLabv3DepthMulti(nn.Module):
    def __init__(self, nRGBChannels=config.NUM_RGB_CHANNELS, nDChannels=config.NUM_D_CHANNELS,
        ...
        self.aspp1_c1 = ASPP_module(resnet_rgbd_feats, 256, rate=rates[0])
        self.aspp2_c1 = ASPP_module(resnet_rgbd_feats, 256, rate=rates[1])
        self.aspp3_c1 = ASPP_module(resnet_rgbd_feats, 256, rate=rates[2])
        self.aspp4_c1 = ASPP_module(resnet_rgbd_feats, 256, rate=rates[3])
        ...
        self.conv2_c1 = nn.Conv2d(resnet_rgbd_low_level_feats, 48, 1, bias=False)
        ...
        self.aspp1_c2 = ASPP_module(resnet_rgbd_feats, 256, rate=rates[0])
        self.aspp2_c2 = ASPP_module(resnet_rgbd_feats, 256, rate=rates[1])
        self.aspp3_c2 = ASPP_module(resnet_rgbd_feats, 256, rate=rates[2])
        self.aspp4_c2 = ASPP_module(resnet_rgbd_feats, 256, rate=rates[3])
        ...
        # adopt [1x1, 48] for channel reduction.
        self.conv2_c2 = nn.Conv2d(resnet_rgbd_low_level_feats, 48, 1, bias=False)
