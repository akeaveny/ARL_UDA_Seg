...
if __name__ == '__main__':
    dst = GTA5DataSet(rgb_list='/home/akeaveny/git/ARL_UDA_Seg/dataset/gta5_list/rgb_train_list.txt',
                            labels_list='/home/akeaveny/git/ARL_UDA_Seg/dataset/gta5_list/labels_train_list.txt')
